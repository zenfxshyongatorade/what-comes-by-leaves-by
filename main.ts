...
function Levels () {
    game.showLongText("Welcome! please follow these steps to play!", DialogLayout.Full)
    game.showLongText("1. You have 8 lives, each time the fireball hits you, you lose a heart", DialogLayout.Full)
    game.showLongText("2. Your owner CAN protect you, trap the fireball onto your owner, they will get rid of it, increasing your points by 1", DialogLayout.Full)
    game.showLongText("3. when you get 15 points, you win! ", DialogLayout.Full)
    scene.setBackgroundImage(img`
        ...
        `)
    game.showLongText("The fireball is fast! have fun!", DialogLayout.Bottom)
    info.setScore(0)
    info.setLife(8)
    scene.setBackgroundImage(img`
    ...
    controller.moveSprite(YOu_corg)
...
let owner: Sprite = null
let YOu_corg: Corgio = null
Levels()
